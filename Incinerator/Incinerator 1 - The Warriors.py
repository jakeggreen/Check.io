...
class Warrior():
	...
	def make_attack(self, unit_1, unit_2):
		print(f'Attacker hits defender for {unit_1.attack}.')
		unit_2.health = unit_2.health - unit_1.attack
		print(f'Defender has {unit_2.health} health remaining')
		if unit_2.health <= 0:
			unit_2.is_alive = False
			return unit_2.is_alive
		return unit_2.health
